module.exports = app => {
  ...
  router.get(
    '/address/:address/brc20-balance/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.brc20TokenBalance
  )
  router.get(
    '/address/:address/txs',
  ...
  router.get(
    '/address/:address/brc20-txs/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.brc20TokenTransactions
  )
  router.get(
    '/address/:address/brc20-mempool-txs/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.brc20TokenMempoolTransactions
  )
  router.get(
  ...
  router.get(
    '/address/:address/brc20-balance-history',
    addressMiddleware, paginationMiddleware,
    controller.address.brc20BalanceHistory
  )
  router.get(
    '/address/:address/brc20-balance-history/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.brc20BalanceHistory
  )
  ...
  router.get(
    '/contract/:contract/brc20-balance-history',
    contractMiddleware, paginationMiddleware,
    controller.contract.brc20BalanceHistory
  )
  router.get(
    '/contract/:contract/brc20-balance-history/:token',
  ...
  router.get(
    '/brc20',
    paginationMiddleware,
    controller.brc20.list
  )
  router.get(
    '/brc20/txs',
    paginationMiddleware,
    controller.brc20.allTransactions
  )
  router.get(
    '/brc20/:token/txs',
    middleware.contract('token'), paginationMiddleware, blockFilterMiddleware,
    controller.brc20.transactions
  )
  router.get(
    '/brc20/:token/rich-list',
    middleware.contract('token'), paginationMiddleware,
    controller.brc20.richList
  )
  router.get(
    '/brc721',
    paginationMiddleware,
    controller.brc721.list
  )
