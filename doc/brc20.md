...
- [BRC20 API](#BRC20-API)
  - [BRC20 list](#BRC20-list)
  - [BRC20 Transaction list](#BRC20-Transaction-list)


## BRC20 list
List all brc20 tokens order by transfer transactions count.
...
**Request**
```
GET /brc20/f2033ede578e17fa6231047265010445bca8cf1c/txs?limit=5&offset=0
```
